...
wave create -driver freeze -pattern clock -initialvalue 0 -period 100ps -dutycycle 50 -starttime 0ps -endtime 1000ps sim:/bus/execute_instruction_cpu2 
...
wave modify -driver freeze -pattern constant -value 0 -starttime 0ps -endtime 1000ps Edit:/bus/execute_instruction_cpu2 
WaveCollapseAll -1
